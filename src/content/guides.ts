  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          kind: "p",
          text: "Zoebar Business Group owns its washing station in Amaro, which places cherry intake, processing method, drying and lot formation under direct control rather than sourced through an intermediary. How that record is carried through to the bag is set out in [traceability](/traceability), and the stage-by-stage sequence is in [process](/process).",
        },
      ],
    },
    {
