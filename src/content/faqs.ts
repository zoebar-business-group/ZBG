...
export const AMARO_FAQS: readonly QA[] = [
  ...
  },
  {
    ...
    answer:
      "The Amaro harvest runs approximately September to December each year. Coffee is Ethiopian Arabica grown at 1,700 to 1,800 metres above sea level in Koore Zone, Ethiopia. Lots are processed at Zoebar's own washing station in Amaro as either washed or natural, depending on the lot.",
  },
  {
    question: "How is Amaro coffee processed?",
    answer:
      "Amaro coffee is processed as washed or natural, depending on the lot, at the washing station Zoebar Business Group owns in Amaro, Ethiopia. Owning the station means the processing record attached to a lot is a direct operational record rather than information passed on from a third-party supplier.",
  },
];
...
export const PROCESS_FAQS: readonly QA[] = [
  {
    ...
    answer:
      "Yes. Zoebar Business Group owns the washing station in Amaro, Ethiopia directly. Ownership means cherry intake, processing method, drying and lot formation are controlled directly by Zoebar rather than bought in from a third-party processor.",
  },
  {
    question: "What is the difference between washed and natural processing?",
    answer:
      "In washed processing the fruit is removed from the coffee seed before drying. In natural processing the cherry dries whole with the fruit intact. Zoebar produces both at its own Amaro washing station in Ethiopia, and which method applies is recorded per lot rather than assumed across the harvest.",
  },
];
...
export const TRACEABILITY_FAQS: readonly QA[] = [
  {
    ...
    answer:
      "Zoebar's traceability system is built around lot-level records covering origin in Amaro (Koore Zone), Ethiopia, the processing method applied at Zoebar's own washing station, the harvest period, the quality assessment, and the producers connected to the lot where they have given documented permission to be named. Publishing begins once the first lots are confirmed.",
  },
  {
...
export const ABOUT_FAQS: readonly QA[] = [
  {
    ...
    answer:
      "Zoebar Business Group FZE LLC is a UAE-registered international trading company connecting Ethiopia and international markets. Its flagship focus is Ethiopian Arabica green coffee from Amaro, recently named as Koore Zone, Ethiopia. Zoebar Ethiopia is established in Ethiopia, and Zoebar Business Group owns the company's washing station in Amaro.",
  },
  {
    question: "Where is Zoebar registered?",
    answer:
      "Zoebar Business Group FZE LLC is registered in the United Arab Emirates and operates as an international trading company connecting Ethiopia and international markets. A second entity, Zoebar Ethiopia, is established in Ethiopia. Zoebar Business Group owns the washing station in Amaro, Ethiopia directly.",
  },
  {
