...
const STAGES = [
  {
    ...
    name: "Cherry intake",
    detail:
      "Cherry is delivered to Zoebar's own washing station in Amaro during the harvest window and assessed on arrival.",
    duration: null,
  },
  {
    n: "02",
  ...
  return (
    <>
      ...
      <PageHeader
        ...
        lede={`${OPERATIONS.washingStationOwner} owns the washing station in ${OPERATIONS.washingStationLocation}. Cherry intake, processing method, drying and lot formation are controlled directly, which is what makes the process record attached to a lot an operational record rather than a supplier's claim.`}
        meta={[
          ...
          <div className="grid gap-14 lg:grid-cols-12 lg:gap-16">
            ...
            <div className="lg:col-span-6">
              <Figure
                ...
                alt="Rows of raised drying beds at Zoebar's own washing station in Amaro, with concrete fermentation tanks in the foreground and workers tending the parchment, green hills behind."
                brief="Drying beds in use at Zoebar's own washing station, parchment being turned, showing the working method rather than a styled arrangement."
                caption={`Both methods run at Zoebar's own washing station in ${OPERATIONS.washingStationLocation}.`}
